...
function DealDetail() {
  ...
  const { deal, activities, companies, contacts, attachments, customFields } = loaded;
  if (!deal) return <NotFound what="El deal" back="/deals" backLabel="Ver deals" />;
                ...
                <div className="flex flex-wrap items-center gap-[18px]">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-[5px] text-[13px] text-ink-300">
                      ...
                      {deal.contact ? (
                        <Link href={contactHref(deal.contact.id)}>{deal.contact.name}</Link>
                      ) : (
                        "Sin contacto"
                      )}
                    </div>
