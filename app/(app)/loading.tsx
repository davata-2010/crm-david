/**
 * Esqueleto que se pinta al instante al cambiar de sección.
 * Además de dar sensación de rapidez, permite a Next prefetchear las rutas
 * dinámicas hasta este límite, así que la navegación arranca ya empezada.
 */
